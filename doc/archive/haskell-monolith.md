# Historical Haskell monolith reference

> Snapshot of the pre-modular `haskell/` tree retained for design history.
> Paths and commands below describe that former layout and are not current
instructions. Use the repository and module READMEs for active commands.

# haskell/ — the former Haskell implementation
