...
The TUI is a process frontend. Import descriptor, protocol, control, snapshot,
store-reference, and catalogue contracts from `Agentic.Runtime`; never import
`Agentic.Cli`, DSL authoring types, plans, costs, workflow registries, or
concrete engines. Launch the configured executable by direct argv in machine
mode. Keep navigation and reduction pure; Brick owns drawing and terminal
