...
-- Description : The typed structural language built by the Haskell DSL.
--
-- A port of @Agentic/Core/Plan.lean@ — questions, contexts, the five term
-- formers, substitution, grafting, and the derived authoring forms. Static
-- interpretation belongs to @agentic-plan@ and cost interpretation to
-- @agentic-cost@; this module contains only the representation they consume.
--
