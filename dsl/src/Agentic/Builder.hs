...
import Agentic.DSL.Plan hiding (panel, panelText)
import qualified Agentic.DSL.Plan as P
import Agentic.Raw
  ( Addressee (..),
    Chunk (..),
    Code (..),
...
-- 'Agentic.DSL.Plan.PRet', and @Plan.graft_ret@ says @graft (ret e) k = k _ Sub.id
