...
`Harden` exports the flagship `hardenProgram`. The corpus freezes its
first-order term as entry `example-000`, and `model/Agentic/Core/DslFlagship.lean`
...
Keep the examples small, symbolic, and independent of engines. `hardenProgram`
and `helloProgram` must print exactly as their frozen fixtures do. Help pages
and canned answers stay in `cli/example`.
